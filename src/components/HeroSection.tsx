        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-10 lg:mb-0 lg:pr-10">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-hoa-darkBlue leading-tight mb-4">
              <span className="text-hoa-blue">BoardGuardian:</span> AI-Driven Risk & Compliance Assistant for HOA Boards
            </h1>
            ...
            <p className="text-hoa-darkGray mb-8">
              BoardGuardian helps homeowner association boards stay ahead of risks, simplify compliance, and make informed decisions with AI-powered insights.
            </p>
          ...
          <div className="lg:w-1/2 relative">
            <div className="bg-white rounded-lg shadow-xl p-6 border border-hoa-lightGray animate-float">
              <div className="bg-hoa-blue bg-opacity-10 rounded-lg p-4 mb-4">
                ...
                <div className="bg-white rounded p-3 shadow-sm">
                  <div className="mb-2 pb-2 border-b border-dashed border-hoa-lightGray">
                    <span className="text-sm font-medium text-hoa-darkBlue">BoardGuardian Analysis:</span>
                  </div>
              ...
              <div className="bg-hoa-teal bg-opacity-10 rounded-lg p-4">
                ...
                <div className="bg-white rounded p-3 shadow-sm">
                  <div className="mb-2 pb-2 border-b border-dashed border-hoa-lightGray">
                    <span className="text-sm font-medium text-hoa-darkBlue">BoardGuardian Summary:</span>
                  </div>
